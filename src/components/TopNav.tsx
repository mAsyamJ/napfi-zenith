        ...
        <div className="bg-background/80 backdrop-blur-md border border-border rounded-xl sm:rounded-2xl shadow-lg px-2 sm:px-4 lg:px-6">
          <div className="flex items-center justify-between py-3 sm:py-4 gap-2 sm:gap-3">
            <div className="flex items-center gap-2 sm:gap-4 lg:gap-6 min-w-0">
              <Link to="/" className="text-base sm:text-lg font-semibold text-foreground tracking-tight font-jakarta whitespace-nowrap">
                NapaFi
              </Link>
              ...
              <nav className="lg:hidden flex items-center gap-2 sm:gap-3 md:gap-4 overflow-x-auto scrollbar-hide">
                <Link to="/" className="text-xs sm:text-sm font-medium text-muted-foreground hover:text-foreground transition-colors whitespace-nowrap">Explore</Link>
                <Link to="/swap" className="text-xs sm:text-sm font-medium text-muted-foreground hover:text-foreground transition-colors whitespace-nowrap">Swap</Link>
                <Link to="/deployments" className="text-xs sm:text-sm font-medium text-muted-foreground hover:text-foreground transition-colors whitespace-nowrap">Deploy</Link>
                <Link to="/ai" className="text-xs sm:text-sm font-medium text-muted-foreground hover:text-foreground transition-colors whitespace-nowrap">AI</Link>
              </nav>
            </div>
            ...
            >
              <span className="relative z-10 text-white font-semibold text-xs sm:text-sm whitespace-nowrap">Connect Wallet</span>
